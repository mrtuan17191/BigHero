...
void GameModel::loadAnimations() {
    ...
    this->animations->addObject(new FaceState(STATE_DOOR1_OPEN, true));
    this->animations->addObject(new FaceState(STATE_DOOR1_CLOSE, true));
    this->animations->addObject(new FaceState(STATE_DOOR2_IDLE, true));
    this->animations->addObject(new FaceState(STATE_DOOR2_OPEN, true));
    this->animations->addObject(new FaceState(STATE_DOOR2_CLOSE, true));
    this->animations->addObject(new FaceState(STATE_DOOR3_IDLE, true));
    this->animations->addObject(new FaceState(STATE_DOOR3_OPEN, true));
    this->animations->addObject(new FaceState(STATE_DOOR3_CLOSE, true));
